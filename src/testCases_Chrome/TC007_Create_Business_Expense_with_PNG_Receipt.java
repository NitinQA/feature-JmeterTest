...
public class TC007_Create_Business_Expense_with_PNG_Receipt {
  ...
  @Test
  public void CreateBusinessExpensewithPNGReceipt() throws Exception {
	  ...
	  try{
			...
			Thread.sleep(5000);
			CheckCorporateOrPersonal_Action.CheckCorporateOrPersonal.Execute();
			BusinessExpWithReceipt_Action.BusinessExpWithReceiptPNG_Action.Execute(iTestCaseRow);
