...
public class TC004_Create_Business_Expense_EntertainmentClient {
  ...
  @Test
  public void CreateBusinessExpense_EntertainmentClient() throws Exception {
	  ...
	  try{
		...
		try {
			...
			Log.info("Business Expense created successfully");
			
		} catch (Exception e) {
			Log.error("Business Expense not saved");
		}
